...
$sql = "SELECT nombre, autor, editorial FROM librosA WHERE area = 'Mecanica'";
...
<head>
    <meta charset="UTF-8" />
    <title>Libros Ingeniería Mecánica</title>
...
<header>
    <nav>
        <ul class="menu">
            ...
            <li><a href="../areas/mecanica.php" class="activo">Mecánica</a></li>
