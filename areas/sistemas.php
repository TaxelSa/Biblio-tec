...
$user = "root";
$password = "";
$dbname = "Bibliotec"; // Verifica que el nombre sea correcto (antes pusiste Bibliotec)
...
// Consulta libros del área Sistemas
$sql = "SELECT nombre, autor, editorial, img FROM librosA WHERE area = 'Sistemas'";
...
<head>
    <meta charset="UTF-8" />
    <title>Libros Ingeniería en Sistemas - BiblioTEC</title>
...
<header>
    <nav>
        <ul class="menu">
            ...
            <li><a href="../areas/sistemas.php" class="activo">Sistemas</a></li>
